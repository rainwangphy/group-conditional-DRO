...
class MultilingualDatasetManager(object):
    ...
    def bitext_split_exists(cls, split, src, tgt, data_path, dataset_impl):
        ...
        tgt_exists = cls.split_exists(
            split, src, tgt, lang=tgt, data_path=data_path, dataset_impl=dataset_impl
        ) or cls.split_exists(
            split, tgt, src, lang=tgt, data_path=data_path, dataset_impl=dataset_impl
        )
