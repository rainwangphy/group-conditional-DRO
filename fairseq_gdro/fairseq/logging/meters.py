...
class MetersDict(OrderedDict):
    ...
    def state_dict(self):
        return [
            ...
            and not isinstance(self[key], MetersDict._DerivedMeterWithKey)
        ]
    ...
    def reset(self):
        ...
        for meter in self.values():
            if isinstance(meter, MetersDict._DerivedMeter) or isinstance(
                meter, MetersDict._DerivedMeterWithKey
            ):
                continue
            meter.reset()
